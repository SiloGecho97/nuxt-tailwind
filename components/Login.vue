<template>
     <div>
      <div class="flex justify-between">
        <div class="relative md:w-2/3 h-screen hidden md:flex flex-col justify-between p-8 bg-gradient-to-br from-purple-800 via-purple-900 to-indigo-900 text-white">
          <div>
        ...
        <div class="w-full flex flex-col max-w-xl  mx-auto ">
          <div class="pt-16 px-16">
            <div class="text-2xl text-gray-700">
              Welcome to <b class="text-purple-700">Pairing</b>
            </div>
          ...
          <div class="py-16 px-16 text-gray-700">
            ...
            <div class="flex flex-col items-center my-6">
              <h1>
                ...
                <a class="text-purple-700 mx-1"> Signup</a>
              </h1>
