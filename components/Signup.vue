<template>
     <div>
      <div class="flex justify-between">
        <div class="relative md:w-2/3  hidden md:flex flex-col justify-between p-8 bg-gradient-to-br from-purple-800 via-purple-900 to-indigo-900 text-white">
          <div>
            <header class="mx-2 my-4">
              <span class="text-lg text-purple-200 opacity-50">TAPHA</span>
        ...
        <div class="w-full flex flex-col max-w-xl  mx-auto ">
          <div class="pt-16 px-16">
            <div class="text-2xl text-gray-700">
              Welcome to <b class="text-purple-700">Tapha</b>
            </div>
          ...
          <div class="py-16 px-16 text-gray-700">
            ...
            <div class="mb-3 pt-0">
              <input
                type="checkbox"
                class="my-2 px-3 py-3 placeholder-purpleGray-300 text-purpleGray-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring "
              />
            ...
            <div class="flex flex-col items-center my-6">
              <h1>
                ...
                <a class="text-purple-700 mx-1"> Login</a>
              </h1>
              {/* <a class="text-purple-700 mx-2">Forgot password?</a> */}
            </div>
          </div>
        </div>
      </div>
